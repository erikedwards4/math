...
descr += "The means and stds are estimated from X.\n";
descr += "\n";
...
descr += "\n";
descr += "Note that this is identical to mean0 followed by std1.\n";
descr += "\n";
descr += "Examples:\n";
descr += "$ zscore X -o Y \n";
descr += "$ zscore -d1 X > Y \n";
...
if (dim>3u) { cerr << progstr+": " << __LINE__ << errstr << "dim must be 0 or 1" << endl; return 1; }
