...
descr += "The 'unbiased' estimate is unbiased only if normally distributed.\n";
descr += "\n";
descr += "Examples:\n";
...
if (L<3u) { cerr << progstr+": " << __LINE__ << errstr << "L (length of vecs in X along dim) must be > 2" << endl; return 1; }
