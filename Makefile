...
#Functions that use C-style complex numbers must be compiled with g++-7,
#so the choice of compiler at the top (CC) applies to all the other functions.
...
INCLS=-Ic -I../util
CFLAGS=-O2 -ffast-math -march=native $(INCLS)
...
zeros: srci/zeros.cpp c/zeros.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
...
inf: srci/inf.cpp c/inf.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm
...
randi: srci/randi.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm
randu: srci/randu.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm
randn: srci/randn.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm

Uniform: uniform_int uniform_real
uniform_int: srci/uniform_int.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
uniform_real: srci/uniform_real.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2

Bernoulli: bernoulli binomial negative_binomial geometric
bernoulli: srci/bernoulli.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
binomial: srci/binomial.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
negative_binomial: srci/negative_binomial.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
geometric: srci/geometric.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2

Poisson: poisson exponential gamma weibull extreme_value
poisson: srci/poisson.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
exponential: srci/exponential.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
gamma: srci/gamma.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
weibull: srci/weibull.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
extreme_value: srci/extreme_value.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2

Normal: normal lognormal chi_squared cauchy fisher_f student_t
normal: srci/normal.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
lognormal: srci/lognormal.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
chi_squared: srci/chi_squared.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
cauchy: srci/cauchy.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
fisher_f: srci/fisher_f.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2
student_t: srci/student_t.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-conversion; $(CC) obj/$@.o -obin/$@ -largtable2

Sampling: discrete piecewise_constant piecewise_linear
discrete: srci/discrete.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
piecewise_constant: srci/piecewise_constant.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
piecewise_linear: srci/piecewise_linear.cpp; $(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
...
transpose: srci/transpose.cpp c/transpose.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lopenblas
...
sin: srci/sin.cpp c/sin.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; g++-7 -c src/$@.cpp -oobj/$@.o -Wall -Wextra -std=gnu++14 $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm
...
erf: srci/erf.cpp c/erf.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; g++-7 -c src/$@.cpp -oobj/$@.o -Wall -Wextra -std=gnu++14 $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm -lcerf
...
prctile: srci/prctile.cpp c/prctile.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -llapacke -lm
median: srci/median.cpp c/median.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -llapacke
max: srci/max.cpp c/max.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lm
min: srci/min.cpp c/min.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
amax: srci/amax.cpp c/amax.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lopenblas -lm
...
var: srci/var.cpp c/var.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; g++-7 -c src/$@.cpp -oobj/$@.o -Wall -Wextra -std=gnu++14 $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2
...
dot: srci/dot.cpp c/dot.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; g++-7 -c src/$@.cpp -oobj/$@.o -Wall -Wextra -std=gnu++14 $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lopenblas
...
spearman: srci/spearman.cpp c/spearman.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-padded; $(CC) obj/$@.o -obin/$@ -largtable2
...
ranks: srci/ranks.cpp c/ranks.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; $(CC) -c src/$@.cpp -oobj/$@.o $(WFLAG) $(STD) $(CFLAGS) -Wno-padded; $(CC) obj/$@.o -obin/$@ -largtable2 -lm
...
solve: srci/solve.cpp c/solve.c
	$(ss) -vd srci/$@.cpp > src/$@.cpp; g++-7 -c src/$@.cpp -oobj/$@.o -Wall -Wextra -std=gnu++14 $(CFLAGS); $(CC) obj/$@.o -obin/$@ -largtable2 -lopenblas -llapacke
