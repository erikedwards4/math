...
int mm2_s (float *Y, const float *X1, const float *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor);
int mm2_d (double *Y, const double *X1, const double *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor);
int mm2_c (float *Y, const float *X1, const float *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor);
int mm2_z (double *Y, const double *X1, const double *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor);

int mm2t_s (float *Y, const float *X1, const float *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor, const char tr);
int mm2t_d (double *Y, const double *X1, const double *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor, const char tr);
int mm2t_c (float *Y, const float *X1, const float *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor, const char tr);
int mm2t_z (double *Y, const double *X1, const double *X2, const size_t R1, const size_t C1, const size_t R2, const size_t C2, const char iscolmajor, const char tr);

int matmul3t_s (float *Y, const float *X1, const float *X2, const float *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr);
int matmul3t_d (double *Y, const double *X1, const double *X2, const double *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr);
int matmul3t_c (float *Y, const float *X1, const float *X2, const float *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr);
int matmul3t_z (double *Y, const double *X1, const double *X2, const double *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr);
...
int matmul3t_c (float *Y, const float *X1, const float *X2, const float *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr)
{
    if (tr)
    {
        ...
        {
            float *X12;
            if (!(X12=(float *)malloc(2*C1*C2*sizeof(float)))) { fprintf(stderr,"error in matmul3t_c: problem with malloc. "); perror("malloc"); return 1; }
        ...
        {
            float *X23;
            if (!(X23=(float *)malloc(2*R2*C3*sizeof(float)))) { fprintf(stderr,"error in matmul3t_c: problem with malloc. "); perror("malloc"); return 1; }
    ...
    else
    {
        ...
        {
            float *X23;
            if (!(X23=(float *)malloc(2*R2*R3*sizeof(float)))) { fprintf(stderr,"error in matmul3t_c: problem with malloc. "); perror("malloc"); return 1; }
...
int matmul3t_z (double *Y, const double *X1, const double *X2, const double *X3, const size_t R1, const size_t C1, const size_t R3, const size_t C3, const char iscolmajor, const char tr)
{
    if (tr)
    {
        ...
        {
            double *X12;
            if (!(X12=(double *)malloc(2*C1*C2*sizeof(double)))) { fprintf(stderr,"error in matmul3t_z: problem with malloc. "); perror("malloc"); return 1; }
        ...
        {
            double *X23;
            if (!(X23=(double *)malloc(2*R2*C3*sizeof(double)))) { fprintf(stderr,"error in matmul3t_z: problem with malloc. "); perror("malloc"); return 1; }
    ...
    else
    {
        ...
        {
            double *X23;
            if (!(X23=(double *)malloc(2*R2*R3*sizeof(double)))) { fprintf(stderr,"error in matmul3t_z: problem with malloc. "); perror("malloc"); return 1; }
