...
int var_s (float *Y, float *X, const int R, const int C, const int dim, const char iscolmajor, const char biased);
int var_d (double *Y, double *X, const int R, const int C, const int dim, const char iscolmajor, const char biased);
int var_c (float *Y, float *X, const int R, const int C, const int dim, const char iscolmajor, const char biased);
int var_z (double *Y, double *X, const int R, const int C, const int dim, const char iscolmajor, const char biased);
...
int var_s (float *Y, float *X, const int R, const int C, const int dim, const char iscolmajor, const char biased)
{
    ...
    {
        fprintf(stderr,"error in var_s: dim must be 0 or 1.\n"); return 1;
    }
