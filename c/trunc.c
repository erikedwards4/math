...
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = truncf(*X); }
...
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = trunc(*X); }
...
{
    for (size_t n=2u*N; n>0u; --n, ++X, ++Y) { *Y = truncf(*X); }
...
{
    for (size_t n=2u*N; n>0u; --n, ++X, ++Y) { *Y = trunc(*X); }
...
{
    for (size_t n=N; n>0u; --n, ++X) { *X = truncf(*X); }
...
{
    for (size_t n=N; n>0u; --n, ++X) { *X = trunc(*X); }
...
{
    for (size_t n=2u*N; n>0u; --n, ++X) { *X = truncf(*X); }
...
{
    for (size_t n=2u*N; n>0u; --n, ++X) { *X = trunc(*X); }
