...
int isqrt2_s (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_SQRT1_2; }
...
int isqrt2_d (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_SQRT1_2; }
...
int isqrt2_c (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_SQRT1_2; *++Y = 0.0f; }
...
int isqrt2_z (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_SQRT1_2; *++Y = 0.0; }
