...
int ln10_s (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_LN10; }
...
int ln10_d (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_LN10; }
...
int ln10_c (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_LN10; *++Y = 0.0f; }
...
int ln10_z (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_LN10; *++Y = 0.0; }
