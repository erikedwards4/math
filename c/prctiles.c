...
int prctiles_s (float *Y, const float *X, const float *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim);
int prctiles_d (double *Y, const double *X, const double *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim);

int prctiles_inplace_s (float *Y, float *X, const float *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim);
int prctiles_inplace_d (double *Y, double *X, const double *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim);
...
int prctiles_s (float *Y, const float *X, const float *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim)
{
    ...
    {
        if (P[q]<0.0f || P[q]>100.0f) { fprintf(stderr,"error in prctiles_s: prctiles must be in [0 100]\n"); return 1; }
...
int prctiles_d (double *Y, const double *X, const double *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim)
{
    ...
    for (size_t q=0; q<Q; q++)
    {
        if (P[q]<0.0 || P[q]>100.0) { fprintf(stderr,"error in prctiles_d: prctiles must be in [0 100]\n"); return 1; }
...
int prctiles_inplace_s (float *Y, float *X, const float *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim)
{
    ...
    for (size_t q=0; q<Q; q++)
    {
        if (P[q]<0.0f || P[q]>100.0f) { fprintf(stderr,"error in prctiles_inplace_s: prctiles must be in [0 100]\n"); return 1; }
        float p1 = (P[q]/100.0f)*(N1-1);
        i1[q] = (P[q]<100.0f) ? (size_t)floorf(p1) : N1-2;
        i2[q] = i1[q] + 1;
        w2[q] = (P[q]<100.0f) ? p1-floorf(p1) : 1.0f;
...
int prctiles_inplace_d (double *Y, double *X, const double *P, const size_t Q, const size_t R, const size_t C, const size_t S, const size_t H, const char iscolmajor, const size_t dim)
{
    ...
    for (size_t q=0; q<Q; q++)
    {
        if (P[q]<0.0 || P[q]>100.0) { fprintf(stderr,"error in prctiles_inplace_d: prctiles must be in [0 100]\n"); return 1; }
        double p1 = (P[q]/100.0)*(N1-1);
        i1[q] = (P[q]<100.0) ? (size_t)floor(p1) : N1-2;
        i2[q] = i1[q] + 1;
        w2[q] = (P[q]<100.0) ? p1-floor(p1) : 1.0;
