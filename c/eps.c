...
int eps_s (float *Y, const size_t N)
{
    for (size_t n=0; n<N; ++n, ++Y) { *Y = FLT_EPSILON; }
...
int eps_d (double *Y, const size_t N)
{
    for (size_t n=0; n<N; ++n, ++Y) { *Y = DBL_EPSILON; }
...
int eps_c (float *Y, const size_t N)
{
    for (size_t n=0; n<N; ++n, ++Y) { *Y = FLT_EPSILON; *++Y = 0.0f; }
...
int eps_z (double *Y, const size_t N)
{
    for (size_t n=0; n<N; ++n, ++Y) { *Y = DBL_EPSILON; *++Y = 0.0; }
