...
int sqrt2_s (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_SQRT2; }
...
int sqrt2_d (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_SQRT2; }
...
int sqrt2_c (float *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = (float)M_SQRT2; *++Y = 0.0f; }
...
int sqrt2_z (double *Y, const size_t N)
{
    for (size_t n=0u; n<N; ++n, ++Y) { *Y = M_SQRT2; *++Y = 0.0; }
