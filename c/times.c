...
int times_c (float *Y, const float *X1, const float *X2, const int R1, const int C1, const int S1, const int H1, const int R2, const int C2, const int S2, const int H2, const char iscolmajor)
{
    ...
    if (N1==1)
    {
        while (n2<2*N) { Y[n2] = X1[0]*X2[n2]-X1[1]*X2[n2+1]; Y[n2+1] = X1[0]*X2[n2+1]+X1[1]*X2[n2]; n2+=2; }
    }    
    else if (N2==1)
    {
        while (n2<2*N) { Y[n2] = X1[n2]*X2[0]-X1[n2+1]*X2[1]; Y[n2+1] = X1[n2]*X2[1]+X1[n2+1]*X2[0]; n2+=2; }
    }
    else if (N==N1 && N==N2)
    {
        while (n<2*N) { Y[n] = X1[n]*X2[n]-X1[n+1]*X2[n+1]; Y[n+1] = X1[n]*X2[n+1]+X1[n+1]*X2[n]; n+=2; }
    }
    else if (iscolmajor)
    {
...
int times_z (double *Y, const double *X1, const double *X2, const int R1, const int C1, const int S1, const int H1, const int R2, const int C2, const int S2, const int H2, const char iscolmajor)
{
    ...
    if (N1==1)
    {
        //while (n2<2*N) { cblas_zdotu_sub(1,&X1[0],1,&X2[n2],1,(_Complex double *)&Y[n2]); n2+=2; }
        while (n2<2*N) { Y[n2] = X1[0]*X2[n2]-X1[1]*X2[n2+1]; Y[n2+1] = X1[0]*X2[n2+1]+X1[1]*X2[n2]; n2+=2; }
    }    
    else if (N2==1)
    {
...
int times_inplace_c (float *X1, const float *X2, const int R1, const int C1, const int S1, const int H1, const int R2, const int C2, const int S2, const int H2, const char iscolmajor)
{
    ...
    if (N2==1)
    {
        while (n2<2*N) { tmp = X1[n2]*X2[0]-X1[n2+1]*X2[1]; X1[n2+1] = X1[n2]*X2[1]+X1[n2+1]*X2[0]; X1[n2] = tmp; n2+=2; }
    }
    else if (N==N1 && N==N2)
    {
        while (n<2*N) { tmp = X1[n]*X2[n]-X1[n+1]*X2[n+1]; X1[n+1] = X1[n]*X2[n+1]+X1[n+1]*X2[n]; X1[n] = tmp; n+=2; }
    }
    else if (iscolmajor)
    {
