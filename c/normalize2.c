...
{
    if (dim>3u) { fprintf(stderr,"error in normalize2_inplace_s: dim must be in [0 3]\n"); return 1; }
...
{
    if (dim>3u) { fprintf(stderr,"error in normalize2_inplace_d: dim must be in [0 3]\n"); return 1; }
...
{
    if (dim>3u) { fprintf(stderr,"error in normalize2_inplace_c: dim must be in [0 3]\n"); return 1; }
