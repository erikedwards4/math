...
int main(int argc, char *argv[])
{
    ...
    descr += "Flips sign of each element of X.\n";
    descr += "For each element: y = -x.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ neg X -o Y \n";
    descr += "$ neg X > Y \n";
