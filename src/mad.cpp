...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1)
    {
        ...
        //if (codee::mad_s(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor()))
        if (codee::mad_inplace_s(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor()))
    ...
    else if (i1.T==2)
    {
        ...
        //if (codee::mad_d(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor()))
        if (codee::mad_inplace_d(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
