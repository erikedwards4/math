...
int main(int argc, char *argv[])
{
    ...
    descr += "Output Y is a tensor filled with realmax (FLT_MIN or DBL_MIN).\n";
    descr += "This is a small positive number (same as FLT_EPSILON or DBL_EPSILON).\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ realmax -r2 -c3 -o Y \n";
    descr += "$ realmax -r2 -c3 > Y \n";
    descr += "$ realmax -r2 -c3 -s2 -t2 > Y \n";
