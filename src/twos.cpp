...
int main(int argc, char *argv[])
{
    ...
    descr += "Output Y is a tensor (up to 4-D) filled with 2.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ twos -r2 -c3 -o Y \n";
    descr += "$ twos -r2 -c3 > Y \n";
    descr += "$ twos -r2 -c3 -s2 -t2 > Y \n";
