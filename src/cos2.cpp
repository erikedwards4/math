...
int main(int argc, char *argv[])
{
    ...
    descr += "Gets cosine similarity for each pair of vectors in X1, X2 along dim.\n";
    descr += "Thus, output Y has length 1 along dim.\n";
    descr += "\n";
    descr += "Use -d (--dim) to give the dimension (axis) [default=0].\n";
    descr += "Use -d0 to get similarity along cols.\n";
    descr += "Use -d1 to get similarity along rows.\n";
    descr += "Use -d2 to get similarity along slices.\n";
    descr += "Use -d3 to get similarity along hyperslices.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "This is the most frequently used similarity measure.\n";
    descr += "It is the dot product after normalizing to unit L2 norm,\n";
    descr += "but without subtracting the mean (as in cov and cos2).\n";
    descr += "This is equal to the cosine of the angle between the vectors.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ cos2 X1 X2 -o Y \n";
    descr += "$ cos2 -d1 X1 X2 > Y \n";
    descr += "$ cat X1 | cos2 -d2 - X2 > Y \n";
    ...
    if (i1.T==1)
    {
        ...
        if (codee::cos2_s(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
    ...
    else if (i1.T==2)
    {
        ...
        if (codee::cos2_d(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101)
    {
        ...
        if (codee::cos2_c(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102)
    {
        ...
        if (codee::cos2_z(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
