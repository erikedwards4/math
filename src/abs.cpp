...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1)
    {
        ...
        //if (codee::abs_s(Y,X,i1.N()))
        if (codee::abs_inplace_s(X,i1.N()))
    ...
    else if (i1.T==2)
    {
        ...
        //if (codee::abs_d(Y,X,i1.N()))
        if (codee::abs_inplace_d(X,i1.N()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
    ...
    else if (i1.T==101)
    {
        ...
        //if (codee::abs_c(Y,X,i1.N()))
        if (codee::abs_inplace_c(X,i1.N()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
    ...
    else if (i1.T==102)
    {
        ...
        //if (codee::abs_z(Y,X,i1.N()))
        if (codee::abs_inplace_z(X,i1.N()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
