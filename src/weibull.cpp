...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "Random function: weibull_distribution.\n";
    descr += "Outputs tensor of floats from a Weibull distribution, \n";
    descr += "with shape param a>0 and scale param b>0.\n";
    descr += "\n";
    descr += "For complex output, real/imag parts are set separately.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ weibull -a2.5 -b2 -r2 -c3 -o Y \n";
    descr += "$ weibull -a2.5 -b2 -r2 -c3 > Y \n";
    descr += "$ weibull -a2.5 -b2 -r2 -c3 -t102 > Y \n";
    ...
    if (o1.T==1u)
    {
        ...
        weibull_distribution<float> distr(a,b);
