...
int main(int argc, char *argv[])
{
    ...
    descr += "Output Y is a tensor (up to 4-D) filled with pi/4 (constant M_PI_4).\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ pi_4 -r2 -c3 -o Y \n";
    descr += "$ pi_4 -r2 -c3 > Y \n";
    descr += "$ pi_4 -r2 -c3 -s2 -t2 > Y \n";
