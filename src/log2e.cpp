...
int main(int argc, char *argv[])
{
    ...
    descr += "Output Y is a tensor (up to 4-D) filled with log2(e) (constant M_LOG2E).\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ log2e -r2 -c3 -o Y \n";
    descr += "$ log2e -r2 -c3 > Y \n";
    descr += "$ log2e -r2 -c3 -s2 -t2 > Y \n";
