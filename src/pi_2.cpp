...
int main(int argc, char *argv[])
{
    ...
    descr += "Output Y is a tensor (up to 4-D) filled with pi/2 (constant M_PI_2).\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ pi_2 -r2 -c3 -o Y \n";
    descr += "$ pi_2 -r2 -c3 > Y \n";
    descr += "$ pi_2 -r2 -c3 -s2 -t2 > Y \n";
