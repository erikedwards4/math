...
int main(int argc, char *argv[])
{
    ...
    descr += "Gets exp (e.^X) of each element of X.\n";
    descr += "For each element: y = exp(x).\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ exp X -o Y \n";
    descr += "$ exp X > Y \n";
