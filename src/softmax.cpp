...
int main(int argc, char *argv[])
{
    ...
    descr += "Softmax function for each vector in X along dim.\n";
    descr += "Output Y has the same size as X.\n";
    descr += "\n";
    descr += "This is a common layer-wise activation function for NNs.\n";
    descr += "\n";
    ...
    descr += "Examples:\n";
    descr += "$ softmax X -o Y \n";
    descr += "$ softmax -d1 X > Y \n";
    descr += "$ cat X | softmax -d2 > Y \n";
    ...
    if (i1.T==1u)
    {
        ...
        //if (codee::softmax_s(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
    ...
    else if (i1.T==2)
    {
        ...
        //if (codee::softmax_d(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
