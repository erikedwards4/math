...
int main(int argc, char *argv[])
{
    ...
    else if (i1.T==2u)
    {
        ...
        //if (codee::insert_sort_d(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
        if (codee::insert_sort_inplace_d(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,a))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
    ...
    else if (i1.T==102u)
    {
        ...
        //if (codee::insert_sort_z(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
        if (codee::insert_sort_inplace_z(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,a))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
