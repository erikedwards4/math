...
int main(int argc, char *argv[])
{
    ...
    descr += "Gets the Lp distance between each pair of vectors in X1, X2 along dim.\n";
    descr += "Thus, output Y has length 1 along dim.\n";
    descr += "\n";
    descr += "This is the Lp norm of the difference vector.\n";
    descr += "This sums the pth power of the difference vecs, \n";
    descr += "and then takes the pth root: sum(|X1-X2|^p)^1/p \n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ distp X1 X2 -o Y \n";
    descr += "$ distp -d1 -p1.5 X1 X2 > Y \n";
    descr += "$ cat X1 | distp -d2 - X2 > Y \n";
    ...
    if (i1.T==1u)
    {
        ...
        if (codee::distp_s(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim,float(p)))
    ...
    else if (i1.T==2)
    {
        ...
        if (codee::distp_d(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim,double(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101u)
    {
        ...
        if (codee::distp_c(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim,float(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102u)
    {
        ...
        if (codee::distp_z(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim,double(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
