...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1u)
    {
        ...
        //if (codee::idr_s(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
        if (codee::idr_inplace_s(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
    ...
    else if (i1.T==2)
    {
        ...
        //if (codee::idr_d(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
        if (codee::idr_inplace_d(Y,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
