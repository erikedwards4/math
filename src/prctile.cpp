...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1)
    {
        ...
        //if (codee::prctile_s(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor(),float(p)))
        if (codee::prctile_inplace_s(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor(),float(p)))
    ...
    else if (i1.T==2)
    {
        ...
        //if (codee::prctile_d(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor(),double(p)))
        if (codee::prctile_inplace_d(Y,X,i1.R,i1.C,i1.S,i1.H,dim,i1.iscolmajor(),double(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
