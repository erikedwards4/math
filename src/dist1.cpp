...
int main(int argc, char *argv[])
{
    ...
    descr += "Gets the L1 distance between each pair of vectors in X1, X2 along dim.\n";
    descr += "Thus, output Y has length 1 along dim.\n";
    descr += "\n";
    descr += "This is the Manhattan vector distance (L1 norm of X1-X2),\n";
    descr += "which is the sum of absolute differences along dim.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ dist1 X1 X2 -o Y \n";
    descr += "$ dist1 -d1 X1 X2 > Y \n";
    descr += "$ cat X1 | dist1 -d2 - X2 > Y \n";
    ...
    if (i1.T==1u)
    {
        ...
        if (codee::dist1_s(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
    ...
    else if (i1.T==2)
    {
        ...
        if (codee::dist1_d(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101u)
    {
        ...
        if (codee::dist1_c(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102u)
    {
        ...
        if (codee::dist1_z(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
