...
int main(int argc, char *argv[])
{
    ...
    descr += "Matrix multiplication of inputs X1, X2.\n";
    descr += "Thus, output Y has size R1xC2.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ matmul2 X1 X2 -o Y \n";
    descr += "$ matmul2 X1 X2 > Y \n";
    descr += "$ cat X1 | matmul2 - X2 > Y \n";
    ...
    if (i1.T==1)
    {
        ...
        if (codee::matmul2_s(Y,X1,X2,i1.R,i1.C,i2.R,i2.C,o1.iscolmajor()))
    ...
    else if (i1.T==2)
    {
        ...
        if (codee::matmul2_d(Y,X1,X2,i1.R,i1.C,i2.R,i2.C,o1.iscolmajor()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101)
    {
        ...
        if (codee::matmul2_c(Y,X1,X2,i1.R,i1.C,i2.R,i2.C,o1.iscolmajor()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102)
    {
        ...
        if (codee::matmul2_z(Y,X1,X2,i1.R,i1.C,i2.R,i2.C,o1.iscolmajor()))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
