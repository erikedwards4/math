...
int main(int argc, char *argv[])
{
    ...
    descr += "Gets Kendall's rank correlation coefficient (tau), \n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ kendall X1 X2 -o Y \n";
    descr += "$ kendall -d1 X1 X2 > Y \n";
    descr += "$ cat X1 | kendall -d2 - X2 > Y \n";
    ...
    if (i1.T==1u)
    {
        ...
        if (codee::kendall_s(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
    ...
    else if (i1.T==2)
    {
        ...
        if (codee::kendall_d(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i2.R,i2.C,i2.S,i2.H,o1.iscolmajor(),dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
