...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1u)
    {
        ...
        if (codee::normalizep_s(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,float(p)))
    ...
    else if (i1.T==2u)
    {
        ...
        if (codee::normalizep_d(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,double(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
    ...
    else if (i1.T==101u)
    {
        ...
        if (codee::normalizep_c(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,float(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
    ...
    else if (i1.T==102u)
    {
        ...
        if (codee::normalizep_z(X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,double(p)))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(X),o1.nbytes()); }
